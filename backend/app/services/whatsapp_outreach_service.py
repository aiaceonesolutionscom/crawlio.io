...
from app.services import whatsapp_service as whatsapp_transport
...
async def get_sender_account(
    ...
    from app.services import whatsapp_account_service
...
async def approve_outreach(
    ...
    from app.services import agent_realtime
