...
const NAV = [
  { to: '/admin/super-admin', label: 'Dashboard', icon: LayoutDashboardIcon, end: true },
  { to: '/admin/super-admin/workspaces', label: 'Workspaces', icon: Building2Icon, end: false },
  { to: '/admin/super-admin/plan-configs', label: 'Plans & Limits', icon: SlidersHorizontalIcon, end: false },
  { to: '/admin/super-admin/platform-admins', label: 'Platform Admins', icon: UsersIcon, end: false },
  { to: '/admin/super-admin/audit-log', label: 'Audit Log', icon: HistoryIcon, end: false },
  { to: '/admin/super-admin/feature-flags', label: 'Feature Flags', icon: FlagIcon, end: false },
  { to: '/admin/super-admin/system-settings', label: 'System Settings', icon: SettingsIcon, end: false },
  { to: '/admin/super-admin/integrations', label: 'API Keys & Integrations', icon: KeyRoundIcon, end: false }
];
      ...
      <aside className="hidden w-[248px] shrink-0 border-r border-ember/30 bg-ink-900 lg:block">
        <div className="sticky top-0 flex h-screen flex-col">
          ...
          <div className="mx-3 mb-2 flex items-center gap-1.5 rounded-lg border border-ember/40 bg-ember/10 px-3 py-2">
            ...
            <span className="font-mono text-[10.5px] uppercase tracking-[0.16em] text-ember">Super Admin</span>
          </div>
