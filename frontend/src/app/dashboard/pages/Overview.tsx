...
export function Overview({ tier }: Props) {
    ...
    <div className="mx-auto w-full max-w-[1180px]">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          value={freeTier ? '—' : '4m 12s'}
          note={freeTier ? 'Pro metric' : 'automated first touch'}
          muted={freeTier} />
      </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={LEADS_OVER_TIME} margin={{ top: 4, right: 4, left: -18, bottom: 0 }}>
                ...
                <Line
                  type="monotone"
                  dataKey="qualified"
                  stroke={freeTier ? '#4B5457' : '#7FD3E8'}
                  strokeWidth={2}
                  dot={false}
                  strokeDasharray={freeTier ? '4 4' : undefined}
                  name="Qualified" />
      ...
      <div className="mt-4">
          <section aria-labelledby="ai-report-title" className="rounded-2xl border border-ink-800 bg-ink-900 p-5">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-3">
              ...
              { t: 'Scoring drift', d: tier === 'enterprise' ? 'Model confidence steady at 0.91, trained on your own historical data.' : 'Model confidence steady at 0.91 — no retraining needed this week.' },
