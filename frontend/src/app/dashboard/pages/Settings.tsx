...
import { BrandingPanel } from '../../../shared/settings/BrandingPanel';
import { SSOSettings } from '../../../shared/settings/SSOSettings';
import { AccountManagerCard } from '../../../shared/settings/AccountManagerCard';
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1.5 text-[13.5px] text-chalk-dim">
                ...
                {isEnterprise && ' Contact your account manager for contract changes.'}
              </p>
            </div>
            {!isEnterprise &&
            <Button
              variant={tier === 'pro' ? 'outline' : undefined}
              onClick={openUpgrade}>
