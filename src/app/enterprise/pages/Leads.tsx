...
import { DownloadIcon, MailIcon, MessageSquareIcon, PencilIcon, PlusIcon, SearchIcon, Trash2Icon } from 'lucide-react';
    ...
    <div className="mx-auto w-full max-w-[1180px]">
      ...
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <p className="font-mono text-[11.5px] uppercase tracking-wider text-chalk-faint">
          {rows.length} shown · {user.workspace.leadsUsed.toLocaleString('en-US')} total · API access enabled
        </p>
      </div>
