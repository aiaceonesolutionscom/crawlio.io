  ...
  return (
    <div className="mx-auto w-full max-w-[1180px]">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard label="Avg. response time" value="4m 12s" note="automated first touch" />
      </div>
          ...
          <div className="h-[260px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={LEADS_OVER_TIME} margin={{ top: 4, right: 4, left: -18, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="qualified" stroke="#7FD3E8" strokeWidth={2} dot={false} name="Qualified" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </section>
      ...
      <div className="mt-4">
        <section aria-labelledby="ai-report-title" className="rounded-2xl border border-ink-800 bg-ink-900 p-5">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-3">
            ...
            { t: 'Scoring drift', d: 'Model confidence steady at 0.91, trained on your own historical data.' },
